...
\includeonly{   % Of course this list allows many more file
    ...
    % contents/back_matter/appendix_retf,
...
\clearpage
\addappheadtotoc
% \include{contents/back_matter/appendix_ims}
% \include{contents/back_matter/appendix_retf}
% \include{contents/back_matter/appendix_measurements}
\include{contents/back_matter/appendix_supblaster}
\include{contents/back_matter/appendix_music}
