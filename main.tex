...
\includeonly{   % Of course this list allows many more file
    contents/front_matter/colophon_dedication,
    ...
    % contents/back_matter/appendix_supblaster,
    % contents/back_matter/appendix_ims,
    % contents/back_matter/appendix_measurements,
...
\include{contents/front_matter/resume}
\end{otherlanguage}
\blankpage{}
\clearpage

\begin{otherlanguage}{french}
\include{contents/front_matter/resume_etendu_fr}
\end{otherlanguage}
\clearpage
\blankpage{}
...
\include{contents/main_matter/chapter0_intro}
\cleardoublepage
...
\cleardoublepage
\include{contents/main_matter/chapter1_acoustics}
\cleardoublepage
\include{contents/main_matter/chapter2_processing}
\cleardoublepage
...
\include{contents/main_matter/chapter_estimation}
\cleardoublepage
\include{contents/main_matter/chapter_blaster}
\cleardoublepage
\include{contents/main_matter/chapter_lantern}
\cleardoublepage
\include{contents/main_matter/chapter_dechorate}
\cleardoublepage
...
\include{contents/main_matter/chapter9_applications}
\cleardoublepage
\include{contents/main_matter/chapter_separake}
\cleardoublepage
\include{contents/main_matter/chapter11_mirage}
\cleardoublepage
\include{contents/main_matter/chapter_dechorateapp}
...
\cleardoublepage
% \parttoc[n]
\include{contents/main_matter/chapter20_conclusion}
\cleardoublepage
...
\clearpage
% \addappheadtotoc
% \appendix\include{contents/back_matter/appendix_supblaster}
% \appendix\include{contents/back_matter/appendix_ims}
% \appendix\include{contents/back_matter/appendix_measurements}
...
\includepdf[pages=-]{assets/last.pdf}
