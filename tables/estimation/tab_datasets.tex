...
\begin{tabular}{l|c|c|c|ccc|c|l|l}
    ...
    \begin{tabular}[c]{@{}l@{}} \citeonly{crocco2017uncalibrated}\end{tabular} &
      ...
      \multicolumn{1}{c|}{17} &
      12 &
      \begin{tabular}[c]{@{}l@{}}Accurate 3D calibration\\ Many mic and src pos.\end{tabular} &
      RooGE \\
     \hline
    ...
    \citeonly{remaggi2019modeling} &
      ...
      \\
    \hline
    \begin{tabular}[c]{@{}l@{}}BUT Reverb\\ \citeonly{szoke2019building} \end{tabular} &
      \cmark &
      \xmark&
      $\sim$ &
      ...
      SE \\ \hline
    \begin{tabular}[c]{@{}l@{}}VoiceHome\\ \citeonly{bertin2019voicehome} \end{tabular} &
       \cmark &
       \xmark&
       \xmark&
      \multicolumn{1}{l|}{188} &
    ...
    \dEchorate{} (Ch.~\ref{ch:dechorate}) &
      ...
      \begin{tabular}[c]{@{}l@{}}\textbf{RooGE}\\ \textbf{SE}\end{tabular}
      \\
