...
\openepigraph{
    I'm here 'cause I [messed up]\\
    Somebody jump in my computer server\\
And take the information out\\
Gentleman, gentleman}{Venetian Snares, \textit{Gentleman}}
\vspace{-2.5em}
...
\acp{RIR} are estimated with the ESS technique \citeonly{farina2007advancements}:
...
\begin{enumerate}[label=(\roman*)]
    ...
    \item \label{it:decharate:mds} By solving a simple \acf{MDS} problem \citeonly{dokmanic2015relax, Crocco2016, Plinge2016acoustic}, refined microphone and source positions were computed.
...
} was used the equalized echograms $\bar{\eta}_{n}(l)$ to provide an initial guess on the peak positions, which was manually correct afterwards.
