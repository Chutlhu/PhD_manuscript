...
The exact effect of the time-domain convolution in the \ac{STFT} would be modeled by cross-band filters~\citeonly{avargel2007system} performing a double convolution along time and frequency axes.\sidenote{%
    The interested reader can refer to~\citeonly{girin2019audio} for a review on the topic applied to audio source separation
} However, these models are not investigated in this thesis work.
