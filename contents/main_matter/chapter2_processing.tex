...
\begin{figure}[t]
    ...
    \centering
        ...
        \draw (393,153.33) node  {\includegraphics[width=52.5pt,height=35pt]{processing/py-freq_segment-0.png}};
        %Image [id:dp3443235626087914]
        \draw (436,183.33) node  {\includegraphics[width=52.5pt,height=35pt]{processing/py-freq_segment-1.png}};
        %Image [id:dp2979363128108309]
        \draw (110,146.5) node  {\includegraphics[width=105pt,height=26.25pt]{processing/py-time_segment-0.png}};
        ...
        \draw (156.75,50.81) node  {\includegraphics[width=244.88pt,height=61.22pt]{processing/py-waveform.png}};
        ...
        \draw (385,130) node  {\includegraphics[width=67.5pt,height=45pt]{processing/py-freq_segment-2.png}};
        ...
        \draw (128,113.25) node  {\includegraphics[width=87pt,height=10.13pt]{processing/py-windows.png}};
