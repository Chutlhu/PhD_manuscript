...
Secondly, by the \textit{convolution theorem}, the source spatial images in~\cref{eq:processing:mixing} writes as:
...
\subsection{Continuos \vs/ Discrete Frequency domain}
