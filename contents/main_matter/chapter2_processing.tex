...
\newthought{Steering Vector}\label{eq:processing:steering}
...
\subsection{Time-Frequency Analysis, Processing and Synthesis}
...
\newthought{Analysis} is the process of convert the signal in the time-frequency domain.
\newthought{Processing} is the process of convert the signal back to its original domain.
\newthought{Synthesis} is the process of convert the signal back to its original domain.
...
\newthoughtpar{Synthesis \vs/ Analysis}
