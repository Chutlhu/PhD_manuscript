...
This approach is used in~\citeonly{o2008imaging, o2010automatic, tervo2015direction} and can be generalized by spatial filtering methods, such as beamforming.
...
\marginpar{
    ...
    \captionof{figure}{
        \footnotesize
        Visualization using the \textit{audio camera}.
        The steered responses are calculated using PL-TDOA. Also shown are the impulse responses for 6 microphones.
        The numbered boxes indicate events shown in the audio camera.}
    \label{fig:estimation:audiocamera}
}

% The main limitation on cross-correlation methods is their , especially with noisy environments, transmitted signals of limited bandwidth and low energy reflections with respect to the direct path\citeonly{chen2006time}.
% The main drawbacks...
