...
The \ReTF/ are estimated using the generalized eigenvector decomposition (GEVD) method was used for the RTFs estimation described in~\citeonly{doclo2003robust}.
Finally, the late reverberation reverberation \xPSD/, $\sigma_{\mathtt{lr}}^2$, is estimated as suggested in~\citeonly{schwartz2016joint}.
