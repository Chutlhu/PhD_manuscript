...
\mynewline
Together with~\cref{ch:lantern}, this chapter describes methods and results published in~\citeonly{di2019mirage}, which considers only stereophonic recordings.
...
\newthought{In the work} \cite{di2019mirage} we proposed to combine the best of the two worlds:
...
\citeonly{bergamo2004collaborative,korhonen2008acoustic}
