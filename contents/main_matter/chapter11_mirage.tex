...
be used to reconstruct the geometry of an audio scene \citeonly{Nakashima2010,dokmanic2013acoustic,An2018}
or to improve performance of signal enhancement methods \citeonly{flanagan1993spatially, dokmanic2015raking,Scheibler2017}.
In \citeonly{Nakashima2010}, some ad-hoc reflectors are used as artificial \textit{pinnae}
to estimate elevation based on a simple reflection model.
In \citeonly{An2018}, cameras, depth sensors and laser sensors are used to
...
with phase transform (GCC-PHAT) method \citeonly{Knapp1976,Blandin2012}.
...
This method was showed to be state-of-the-art in a large benchmark \citeonly{Blandin2012}.
...
a principle which was successfully applied in the steered response power with phase transform (SRP-PHAT) method \citeonly{DiBiase2001}.
