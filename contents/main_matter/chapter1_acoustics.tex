...
\begin{figure}[t]
    ...
    \end{minipage}
    \caption{Schematic illustration of the shape of an \RIR/ and the first 100 ms of a measured one. Image taken from~\citeonly{vincent2018audio}}
...
In particular, by simulating accurately low-frequency components of the \RIR/, they are able to well characterize the \textit{room modes}\sidenote{
    ...
    such as concert halsl and recording studios or when producing musically pleasing reverbs.
...
} This map is then used as a prior distribution for drawing random sets of impulses which are used to form the \RIR/.
...
\begin{figure}[t]
    \begin{fullwidth}
        ...
        \resizebox{\linewidth}{!}{
            ...
            \captionof{figure}{%
            \footnotesize
            Time-Frequency regions of the \RIR/ associated to the method that better simulate them.
...
The work of \citeonly{lindau2012perceptual} shows the equivalence between the two definitions.
Due to this, it is an important parameter also in the context of \RIRs/ synthesis as it defines cross-over point for room acoustics simulator using hybrid methods~\citeonly{savioja2015overview}(see \cref{sec:acoustics:simulators}).
