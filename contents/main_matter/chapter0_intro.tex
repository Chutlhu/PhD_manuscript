...
This outstanding capability is not limited to humans and is common to many the creatures we are sharing the physical world with.
...
For instance, the ticking of a metronome or clock provides units of time\marginpar{
...
Our\openepigraph{Everything is connected}{Douglas Adams, \textit{Dirk Gently's Holistic Detective Agency}}
...
Some of the earliest examples in this direction are the works of Flanagan et al\citeonly{flanagan1993spatially, jan1995matched, jan1996sound} for in source enhancement.
