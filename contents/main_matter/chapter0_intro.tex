...
\marginpar{
    \footnotesize
    French philosopher Denis Diderot in 1749  (other sources say it was in 1789) recorded the amazing ability of blind people to not only perceived objects but to accurately judge distance as well.
    Since Diderot’s first account, numerous cases have been reported, until the scientist Donald Griffin coined the name ``[...] \textit{echo location}, not only for the abilities of bats and blind men, but for several other analogous cases''.
}.
