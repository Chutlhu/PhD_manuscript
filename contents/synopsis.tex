...
\newcommand{\synopsisChEstimation}{
    ...
    \cref{sec:estimation:taxonomy} defines the categories of methods according to which the literature can be clustered and analyzed in detail later in~\cref{sec:estimation:sota}.
...
\newcommand{\synopsisChSeparake}{
    ...
    Instead, these works investigate whether sound separation can benefit from the knowledge of early acoustic echoes.
