...
\newcommand{\synopsisChDecharateApp}{
    This chapter present some echo-aware application using the dataset \dEchorate.
    In particular we exemplify the utilization of the database considering two possible use-cases: echo-aware speech enhancement (\cref{sec:dechorateapp:se}) and room geometry estimation (\cref{sec:dechorateapp:rooge}).
    ...
    In the final section (\cref{sec:dechorateapp:conclusion}) the main results are discussed and future perspective will be presented.
}