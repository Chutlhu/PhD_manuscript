\newcommand{\synopsisChAcoustics}{
    ...
    It first defines sound and how it propagates in the environment~\cref{ch:acoustics:sec:wave}, teasing out the fundamental concepts of this thesis: echoes.~\cref{ch:acoustics:sec:reflection} and \acfp{RIR}~\cref{ch:acoustics:sec:rir}.
...
\newcommand{\synopsisChLantern}{
    As opposed to the previous chapter, here, we propose a data-driven approach to estimate echoes properties.
    ...
    To this end, the \ac{AER} problem is modeled as a regression problem for which we propose different solutions based on deep learning tools.
