...
\newcommand{\synopsisChSeparake}{
    ...
    In particular, this works investigate whether sound separation can benefit of the knowledge of acoustic echoes derived from know the locations of a few virtual microphones.
